        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            <form action="/laracast-php/public/login" method="POST" class="space-y-6">
                <div>
                    ...
                    <div class="mt-2">
                        <input id="email" type="email" name="email" required autocomplete="new-email" value="<?= old('email') ?? ' '; ?>" class="block w-full rounded-md bg-white/5 px-3 py-1.5 text-base text-green outline-1 -outline-offset-1 outline-white/10 placeholder:text-gray-500 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500 sm:text-sm/6" />
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input id="password" type="password" name="password" required autocomplete="new-password" class="block w-full rounded-md bg-white/5 px-3 py-1.5 text-base text-green outline-1 -outline-offset-1 outline-white/10 placeholder:text-gray-500 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500 sm:text-sm/6" />
                    </div>
                </div>
